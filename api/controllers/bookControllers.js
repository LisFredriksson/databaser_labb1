...
const { getAllLoans } = require("../repositories/loanRepository");
...
async function search(req, res) {
    ...
    let loan = await getAllLoans()

    console.log(book)

    return res.render('home.ejs', { book, author, genre, loan, title: 'ADD BOOK' })
}
